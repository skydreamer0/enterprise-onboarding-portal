...
<div className="grid-cards">
  ...
  <Card style={{ border: '1px solid rgba(20, 108, 67, 0.3)' }}>
    <h3 style={{ color: 'var(--accent-success)', marginBottom: 'var(--space-4)' }}>✅ 活動時程檢核表</h3>
    <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-4)' }}>
      <div style={{ background: 'var(--surface-subtle)', padding: 'var(--space-3)', borderRadius: 'var(--radius-md)', borderLeft: '3px solid var(--accent-success)' }}>
